#!/usr/bin/env python3
"""Resonance probe: ask the (probable) authoring vintage to 'remember around' its own artifact."""
...
full = open(os.path.expanduser("~/.claude/CLAUDE.md")).read()
DOC = full.split("## Calibration: Track Record")[0].rstrip() + "\n"
...
def main():
    ...
    out = os.path.join(os.path.dirname(os.path.abspath(__file__)), "vibes_results.json")
